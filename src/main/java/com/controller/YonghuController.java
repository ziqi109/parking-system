...
public class YonghuController {
    ...
    public R save(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuService.selectCount(new EntityWrapper<YonghuEntity>().eq("chepaihaoma", yonghu.getChepaihaoma()))>0) {
    ...
    public R update(@RequestBody YonghuEntity yonghu, HttpServletRequest request){
        ...
        if(yonghuService.selectCount(new EntityWrapper<YonghuEntity>().ne("id", yonghu.getId()).eq("chepaihaoma", yonghu.getChepaihaoma()))>0) {
            return R.error("车牌号码已存在");
        }
