<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0px 0px 0","boxShadow":"0px 0px 0px #ccc","margin":"0px auto 0","borderColor":"#000","display":"block","overflow":"hidden","top":"128px","background":"none","borderWidth":"0 0 0px","width":"calc(100% - 230px)","fontSize":"14px","position":"absolute","borderStyle":"solid","height":"auto"}'>
		<scroll-pane ref="scrollPane" class="tags-view-wrapper">
			<div class="tags-view-box" :style='{"width":"auto","boxShadow":"none","whiteSpace":"nowrap","position":"relative","background":"none"}'>
