  ...
  <div :style='{"padding":"20px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f6f6f6"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yonghu'"  label="车牌号码" prop="chepaihaoma">
          <el-input v-model="ruleForm.chepaihaoma"               placeholder="车牌号码" clearable></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.chepaihaoma)&& 'yonghu'==this.flag){
