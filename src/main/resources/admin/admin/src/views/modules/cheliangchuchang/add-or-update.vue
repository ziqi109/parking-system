	...
	<div class="addEdit-block" :style='{"padding":"30px 0","fontSize":"14px","color":"#999","background":"#f6f6f6"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="总时长" prop="zongshizhang">
					<el-input v-model="zongshizhang" placeholder="总时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.zongshizhang" label="总时长" prop="zongshizhang">
					<el-input v-model="ruleForm.zongshizhang" placeholder="总时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="合计费用" prop="hejifeiyong">
					<el-input v-model="hejifeiyong" placeholder="合计费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.hejifeiyong" label="合计费用" prop="hejifeiyong">
					<el-input v-model="ruleForm.hejifeiyong" placeholder="合计费用" readonly></el-input>
				</el-form-item>
...
export default {
	...
	computed: {
		zongshizhang : {
			get: function () {
				...
				this.ruleForm.zongshizhang = hour?hour:0
				return hour?hour:0
			}
		...
		hejifeiyong:{
			get: function () {
				return 1*this.ruleForm.tingchejiage*this.ruleForm.zongshizhang
			}
		},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zongshizhang'){
							this.ruleForm.zongshizhang = obj[o];
							this.ro.zongshizhang = true;
							continue;
						}
						if(o=='hejifeiyong'){
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.zongshizhang==0){
			this.$message.error('总时长不能为空')
			return false
		}
